...
{\bf Address} \> 3 Malomoskovskaya st., Apt. 84, \\ % Address line 1
\> Moscow, 129164, Russia \\ % Address line 2
...
\begin{tabbing} % Enables tabbing
\hspace{3cm} \= \hspace{4cm} \= \kill % Spacing within the block
{\bf Home Phone} \> +7 (495) 682 2488 \\ % Home phone
...
\personalgroup{
\personal{Married. Two children: son (6 years) and daughter (4 years).}
\personal{Would like to relocate to Europe in case of deterioration in political and economical situation in Russia.}
\personal{I love running and driving motorcycles.}
\personal{Prefer Russian literature and auteur theory cinema.}
}
